      ...
      <header className="sticky top-0 z-40 w-full backdrop-blur supports-[backdrop-filter]:bg-background/80 border-b">
        <div className="container mx-auto flex h-16 items-center justify-between">
          <Link to="/" className="flex items-center gap-2">
            <div className="h-8 w-8 rounded-md bg-gradient-to-tr from-primary to-secondary flex items-center justify-center text-white font-bold">Z</div>
            <span className="text-xl font-extrabold tracking-tight bg-clip-text text-transparent bg-gradient-to-r from-primary to-secondary">ZestEats</span>
          </Link>
          ...
          <button className="md:hidden inline-flex items-center justify-center p-2 rounded-md hover:bg-accent" onClick={() => setOpen(o => !o)} aria-label="Toggle menu">
        ...
        <div className="container mx-auto py-10 grid gap-8 md:grid-cols-4 text-sm">
          <div className="space-y-3">
            <div className="flex items-center gap-2">
              <div className="h-8 w-8 rounded-md bg-gradient-to-tr from-primary to-secondary flex items-center justify-center text-white font-bold">Z</div>
              <span className="text-lg font-extrabold tracking-tight">ZestEats</span>
            </div>
            <p className="text-muted-foreground">Next‑gen food delivery connecting diners, restaurants, and couriers with speed and delight.</p>
            <div className="flex gap-2 pt-1">
              <Button size="sm" variant="secondary" className="gap-1"><Utensils className="h-4 w-4"/> Order</Button>
              <Button size="sm" variant="secondary" className="gap-1"><Store className="h-4 w-4"/> Partner</Button>
              <Button size="sm" variant="secondary" className="gap-1"><Bike className="h-4 w-4"/> Deliver</Button>
            </div>
          </div>
          <div>
