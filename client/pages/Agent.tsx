        ...
        <CardHeader className="flex-row items-center justify-between">
          <div>
            ...
            <p className="text-sm text-muted-foreground">
              Control your availability and accept new orders
            </p>
          </div>
          <div className="flex items-center gap-3">
            <span
              className={online ? "text-emerald-600" : "text-muted-foreground"}
            >
              {online ? "Online" : "Offline"}
            </span>
            <Switch checked={online} onCheckedChange={setOnline} />
            <Button className="gap-2">
              <Bike className="h-4 w-4" /> Go to map
            </Button>
          </div>
        </CardHeader>
      </Card>
        ...
        {orders.map((o) => (
          <Card key={o.id} className="overflow-hidden">
            ...
            <CardContent className="space-y-3">
              ...
              <div className="flex items-center gap-2 text-sm text-muted-foreground">
                <Timer className="h-4 w-4" /> ETA {o.eta}
              </div>
              <div className="flex items-center gap-2 text-sm text-muted-foreground">
                <Phone className="h-4 w-4" /> {o.customer}
              </div>
