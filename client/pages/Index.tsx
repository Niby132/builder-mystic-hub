    ...
    <div className="relative">
        ...
        <div className="container mx-auto grid gap-6 py-16 md:grid-cols-2 md:items-center">
          <div className="space-y-6">
            ...
            <p className="text-muted-foreground text-lg">
              ZestEats connects diners, restaurants, and couriers in one sleek
              experience. Browse top bites near you, manage your kitchen, or hit
              the road to deliver joy.
            </p>
            <div className="flex flex-col gap-2 sm:flex-row">
              <a href="/explore" className="inline-flex">
                <button className="inline-flex items-center justify-center gap-2 rounded-md bg-primary px-6 py-3 font-medium text-primary-foreground shadow hover:bg-primary/90">
                  Explore restaurants
                </button>
              </a>
              <div className="flex gap-2">
                <a href="/owner" className="inline-flex">
                  <button className="inline-flex items-center justify-center gap-2 rounded-md border px-6 py-3 font-medium hover:bg-accent">
                    Partner with us
                  </button>
                </a>
                <a href="/agent" className="inline-flex">
                  <button className="inline-flex items-center justify-center gap-2 rounded-md border px-6 py-3 font-medium hover:bg-accent">
                    Deliver with us
                  </button>
                </a>
      ...
      <section className="container mx-auto py-12">
        ...
        <div className="mt-6 grid gap-4 md:grid-cols-3">
          <RoleCard
            title="For Diners"
            desc="Discover nearby restaurants, track orders in real time, and enjoy exclusive deals."
            href="/explore"
            color="from-primary to-secondary"
          />
          <RoleCard
            title="For Restaurants"
            desc="Boost orders, manage menus, and access insights to grow your business."
            href="/owner"
            color="from-emerald-500 to-teal-500"
          />
          <RoleCard
            title="For Couriers"
            desc="Flexible earnings with smart routing, batching, and safety-first tools."
            href="/agent"
      ...
      <section className="container mx-auto py-16">
        <div className="grid gap-8 md:grid-cols-3">
          <Step
            title="Search"
            desc="Enter your address to see what’s cooking near you."
          />
          <Step
            title="Order"
            desc="Customize your meal and pay in seconds with saved preferences."
          />
          <Step
            title="Track"
            desc="Live maps and accurate ETAs keep you in the loop until it arrives."
          />
        </div>
      </section>
        ...
        <div className="rounded-2xl bg-gradient-to-r from-primary to-secondary p-[1px]">
          <div className="rounded-2xl bg-background p-8 md:p-12 grid gap-6 md:grid-cols-2 md:items-center">
            <div>
              ...
              <p className="text-muted-foreground">
                Join thousands of partners growing with ZestEats. Start
...
function Step({ title, desc }: { title: string; desc: string }) {
  return (
    <div className="rounded-xl border p-6 bg-card">
      <div className="h-10 w-10 rounded-md bg-gradient-to-tr from-primary to-secondary text-white flex items-center justify-center font-bold mb-3">
        {title[0]}
      </div>
  ...
  const list: Restaurant[] = [
    {
      ...
      name: "Bao & Buns",
      image:
        "https://images.unsplash.com/photo-1543339308-43f2b83f27a9?q=80&w=1600&auto=format&fit=crop",
      rating: 4.9,
      categories: ["Asian", "Street food"],
      etaMins: 15,
      fee: 0.99,
    },
    {
