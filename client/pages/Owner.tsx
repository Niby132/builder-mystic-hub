...
export default function Owner() {
  ...
  const toggle = (id: number) =>
    setItems((list) =>
      list.map((i) => (i.id === id ? { ...i, available: !i.available } : i)),
    );
  ...
  return (
    <Card>
      <CardHeader className="flex-row items-center justify-between pb-2">
        ...
        <span className="text-xs rounded-md bg-emerald-100 text-emerald-700 dark:bg-emerald-500/10 dark:text-emerald-300 px-2 py-0.5">
          {trend}
        </span>
      </CardHeader>
      <CardContent>
